...
class OfficialFacebookPixelConfig {
  ...
  const FORM_PII_TITLE = 'Use Advanced Matching';
  const FORM_PII_DESCRIPTION = 'Enabling Advanced Matching improves audience building. For example transfers the logged-in users E-Mail address.<br />For businesses that operate in the European Union, you may need to take additional action. Read the <a href="%s" target="_blank">Cookie Consent Guide for Sites and Apps</a> for suggestions on complying with EU privacy requirements. the Facebook Pixel ID';
